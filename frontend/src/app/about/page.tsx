      ...
      <div className="w-[700px]">
        ...
        <div className="mt-2 space-y-2 text-sm">
          <p>
            ...
            marketing tactics and obfuscating documentation to project a facade of stability and transparency to attract deposits.
          </p>
          <p>
            ...
            is likely trying to hide information from you. If the team is anonymous, this gives them the freedom to conduct an overt "rug pull", "soft rug", or insider hack at any
            time in the future.
          </p>
          <p>
          ...
          <p>
            ...
            platform, your risks may far outweigh your gains. Next, we discuss diversification, which is an equally important strategy for risk mitigation.
          </p>
        </div>
